...
class Pregunta3 : AppCompatActivity(), AdapterView.OnItemSelectedListener {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.actividad_pregunta3)
        ...
        botonSiguiente.setOnClickListener {
            ...
            val pregunta4:Intent = Intent(this,Pregunta4::class.java)
            pregunta4.putExtra(getString(R.string.preguntasCorrectas), correctas)
            pregunta4.putExtra(getString(R.string.preguntasErroneas), erroneas)
            pregunta4.putExtra(getString(R.string.preguntasSinContestar), sinContestar)
