...
public class Barberia {
    ...
    public synchronized boolean entrarBarberia(int numCliente) {
        ...
        if (numSillas == numSillasOcupadas) {// la barber�a est� llena
            System.out.println("Sala de espera llena, el cliente " + numCliente + " abandona la peluquer�a");
            return false;
        } else {


            // la barber�a no est� llena, comprobamos si la silla del barbero est� libre
            if (sillaBarberoOcupada) {// la silla del barbero est� ocupada, esperamos en la sala de espera
                numSillasOcupadas++;
