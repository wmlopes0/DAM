...
public class PedirNombre extends javax.swing.JDialog {
    ...
    public PedirNombre(java.awt.Frame parent, boolean modal) {
        ...
        this.getContentPane().setBackground(Color.decode("#d2ffb4"));
    }
    ...
    private void initComponents() {
        ...
        jTextFieldNombre.setFont(new java.awt.Font("Consolas", 2, 18)); // NOI18N

        jButtonAceptar.setFont(new java.awt.Font("Consolas", 3, 18)); // NOI18N
        ...
        jLabel3.setText(" Introduce tu nombre para guardar los resultados.");
