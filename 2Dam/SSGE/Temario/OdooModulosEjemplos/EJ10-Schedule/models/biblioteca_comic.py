...
class BibliotecaComic(models.Model):
    ...
    #Ejemplo que actualiza cada minuto las fechas de publicacion de los comics a la fecha actual
    def actualizar(self):
        modelo=self.env['biblioteca.comic'].search([])
        print("Hola")
        for record in modelo:
            record.fecha_publicacion=date.today()
